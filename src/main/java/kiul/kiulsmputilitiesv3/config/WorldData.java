...
public class WorldData {
        ...
        public static void setup() {
            file = new File(Bukkit.getServer().getPluginManager().getPlugin("Kiul-SMP-Utilities-V3").getDataFolder(), "worlddata.yml");
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    try {
                        ...
                        System.out.println("Failed to save worldData File.");
                    }
                }
