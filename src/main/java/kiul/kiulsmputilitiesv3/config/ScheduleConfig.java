...
public class ScheduleConfig {
        ...
        public static void setup() {
            file = new File(Bukkit.getServer().getPluginManager().getPlugin("Kiul-SMP-Utilities-V3").getDataFolder(), "schedule.yml");
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    try {
                        ...
                        System.out.println("Failed to save schedule file.");
                    }
                }
